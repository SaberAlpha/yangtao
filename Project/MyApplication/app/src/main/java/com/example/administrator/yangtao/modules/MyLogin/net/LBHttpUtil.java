package com.example.administrator.yangtao.modules.MyLogin.net;
...
public class LBHttpUtil {
    ...
    public static void doHttpGetWithHead(final String url,
                                         final String authToken, final BaseCallBack callBack) {
    ...
    //post请求带头部
    public static void doHttpPostHead(final String url, final String authToken,
