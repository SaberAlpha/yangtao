package com.example.administrator.yangtao.net;
...
public class HttpUtil {
     ...
     * @param params 请求的参数
     */
    public static void doHttpReqeust1(final String method, final String url,
                                      final HashMap<String, String> params, final BaseCallBack callBack) {
...
//                    connection.setDoOutput(true);
     ...
     * @param json 请求的参数
     */
    public static void doHttpPostJsonReqeust(final String url,
